...
import com.anas.mealster.infra.database.mappers.toEmailVerificationToken
import com.anas.mealster.infra.database.mappers.toUser
import com.anas.mealster.infra.database.repository.EmailVerificationTokenRepository
...
class EmailVerificationService(
    ...
    @param:Value("\${mealster.email.verification.expiry-hours}") private val expiryHours: Long
) {

    @Transactional
    fun createEmailVerificationToken(email: String): EmailVerificationToken {
